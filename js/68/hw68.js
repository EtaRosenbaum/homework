const pcsMessageBox = (function () {
    ...
    return function (msg, modal, userButtons = ['ok'], callback) {
        ...
        const buttons = createButtons(userButtons, callback, div, modal, modalDiv);
    ...
    function createButtons(buttons = ['ok'], callback, messageBoxDiv, modal, modalDiv) {
        const buttonArray = [];
